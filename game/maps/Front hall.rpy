...
default fhall_mindy_loc = place("Mindy", (141, 499), Jump('fhall_mindy'), "maps/front hallway/mindy_h.png")
default fhall_sword_loc = place("sword", (1364, 329), Jump('fhall_sword'), "maps/front hallway/sword h.png")
