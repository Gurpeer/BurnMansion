default office_desk_loc = place("Desk", (443, 682), Jump('office_desk'), "maps/office/desk.png")
default office_weylon_loc = place("Weylon", (855, 613), Jump('office_weylon'), "maps/office/weylon.png")
default office_firecamp_loc = place("Fire Camp", (1401, 705), Jump('office_firecamp'), "maps/office/fireplace.png")
default office_picture_loc = place("Picture", (1351, 0), Jump('office_picture'), "maps/office/picture.png")
